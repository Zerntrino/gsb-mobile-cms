...
@Component({
  selector: 'app-security-log-list',
...
export class ListComponent implements OnInit {
  ...
  async fetch() {
    ...
    await this.auditLogService.getSecurityLogList(params).subscribe(
      (response) => {
    ...
    this.auditLogService.getSucurityLogListTotal(params).subscribe(
      (response) => {
  ...
  redirect() {
    this.router.navigate(['/security-log'], {
      queryParams: {
        page: this.page,
